Proyecto realizado para trabajo final en ORT, en el cual se desarrolla una aplicación web para la gestión de reservas de entradas para conciertos y eventos musicales. El sistema está orientado a una productora de espectáculos y permite administrar conciertos, usuarios y reservas de forma integral.

La aplicación cuenta con dos perfiles de usuario: clientes, que pueden registrarse, iniciar sesión, explorar conciertos disponibles, ver eventos en oferta y realizar reservas; y administradores, encargados de crear y gestionar conciertos, procesar reservas, administrar cupos y generar informes de ganancias.
